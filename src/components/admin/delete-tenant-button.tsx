...
import { deleteTenant } from "@/app/admin/(panel)/penghuni/actions";
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 text-left">
                ...
                <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                  Apakah Anda yakin ingin menghapus penghuni &ldquo;{tenantName}&rdquo;? Riwayat pembayarannya ikut terhapus dan kamar akan dibebaskan. Tindakan ini tidak dapat dibatalkan.
                </p>
              </div>
            </div>
